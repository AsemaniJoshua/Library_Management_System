      ...
      <div className="lg:flex lg:flex-row bg-white">
        ...
        <div className="max-w-md min-w-sm w-full bg-white p-[80px] flex flex-col gap-[20px] justify-center items-center relative">
            ...
            <img src={LogoBlack} className="w-[60px] h-[60px]" alt="Logo" />
             ...
             <h2 className="text-2xl font-semibold tracking-wider">Check your Mailbox</h2>

             <p className="text-sm text-gray-500">Enter the OTP to proceed</p>

             <form action="" method="post" className="flex flex-col gap-[20px] w-full p-[30px] mt-[-10px]" onSubmit={handleOTP}>

                {/* Username */}
                <input type="text" name="otp" id="otp" placeholder="OTP" className="text-sm rounded-lg py-2 px-4 border border-gray-600" required onChange={(e) => setOTP(e.target.value)} value={otp} />
        ...
        {/* logo side Div */}
        <div className="max-w-md min-w-sm w-full hidden lg:flex lg:flex-col bg-black text-white justify-center items-center p-[50px] gap-[80px] rounded-tl-4xl rounded-bl-4xl">
